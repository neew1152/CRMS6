...
{                                                              //0:เคลียร์มุมเริ่มต้น 1:ไม่เคลียร์มุมเริ่มต้น 2:เคลียร์มุมเริ่มต้นแต่มุมเลี้ยวที่ต้องการ
  ...
  if(WheelDrive==0) sl(BrakeSpeed);
  else SL(BrakeSpeed);
  delay(BrakeTime);
  MotorStop();
}

void TLD(int TurnSpeed, float Degree, int Origin)  //เลี้ยวซ้ายใช้เข็มทิศ Degree 0-359
{                                                                //0:เคลียร์มุมเริ่มต้น 1:ไม่เคลียร์มุมเริ่มต้น 2:เคลียร์มุมเริ่มต้น
  int Status = 0;
  if (Origin != 1) zeroYaw();
...
void TRD(int TurnSpeed, float Degree, int Origin)  //เลี้ยวขวาใช้เข็มทิศ 0-359
{                                                              //0:เคลียร์มุมเริ่มต้น 1:ไม่เคลียร์มุมเริ่มต้น 2:เคลียร์มุมเริ่มต้นแต่มุมเลี้ยวที่ต้องการ
  int Status = 0;
  if (Origin != 1) zeroYaw();
  if(WheelDrive==0) tl(TurnSpeed);
...
void TLDB(int TurnSpeed, float Degree, int Origin)//ถอยโค้งซ้ายใช้เข็มทิศ Degree 0-359
{                                                                //0:เคลียร์มุมเริ่มต้น 1:ไม่เคลียร์มุมเริ่มต้น 2:เคลียร์มุมเริ่มต้น
  int Status = 0;
  if (Origin != 1) zeroYaw();
  if(WheelDrive==0) 
...
void TRDB(int TurnSpeed, float Degree, int Origin)  //ถอยโค้งขวาใช้เข็มทิศ 0-359
{                                                              //0:เคลียร์มุมเริ่มต้น 1:ไม่เคลียร์มุมเริ่มต้น 2:เคลียร์มุมเริ่มต้นแต่มุมเลี้ยวที่ต้องการ
  int Status = 0;
  if (Origin != 1) zeroYaw();
  if(WheelDrive==0) 
