...
int Swing_Left = 100;  //SO สวิงแขนซ้ายเพิ่มง้างออก ลด หุบเข้า
int Swing_Right = 92;  //S1 สวิงแขนขวาเพิ่มง้างออก ลด หุบเข้า

int Open_Left = 50;    //S2 อ้ามือ ชุดมือจับมือซ้ายค่ามากยิ่งหุบ
int Close_Left = 96;  //S2 หุบมือ ชุดมือจับมือซ้ายค่าน้อยยิ่งอ้า

int Open_Right = 50;    //S3 อ้ามือ ชุดมือจับมือขวาค่ามากยิ่งหุบ
int Close_Right = 96;  //S3 หุบมือ ชุดมือจับมือขวา ค่าน้อยยิ่งอ้า
////////////////////////////////////////////////////
...
void servoOpenLeft() {
  for (int i = Close_Left; i > Open_Left - 8; i--) {
...
void servoOpenRight() {
  for (int i = Close_Right; i > Open_Right - 8; i--) {
...
void dropCan_NoShake(char gripper) {
  if (gripper == 'l') {
    ...
    servoWrite(chanal_Gripper_Left, Close_Right - 10);
    servoWrite(chanal_Gripper_Left, Close_Right - 10);
    servoWrite(chanal_Gripper_Left, Close_Right - 10);
    delay(750);
    servoOpenRight();
