...
{
  Balance_Arm('C');
  motorTimeDegree_Enhanced(30, 60, 200, 'L'); SetBack(20 ,250);
  motorStop();delay(50);
  motorTimeDegree_Enhanced(30, 60, 500, 'L'); SetBack(20 ,250 ,'R'); 
  motorStop();delay(50);
}

void box2_community()
{
  // pickCan(5, NO_SWITCH_LR); // RY
  ...
  // SetFront_Wall(20);
  // motorStop();delay(50);
  // motorTimeDegree_Enhanced(-30, -60, 300,'L');
  // motorTimeDegree_Enhanced(30, 60, 200);
  // SetFront(20, 400, 'L'); 
  // motorStop();delay(50);
  // SetBack(20); 
  // motorStop();delay(50);
  // motorTimeDegree_Enhanced(30, 60, 275 ,'R');// hight way
  // SetFront(20); 
  // motorStop();delay(50);
  // motorTimeDegree_Enhanced(-30, -60, 1350,'L');
  // motorTimeDegree_Enhanced(30, 60, 200,'R');
  // SetBack(20,250);
  motorTimeDegree_Enhanced(30, 60, 500);
  lift(10); delay(500);
  spinDegree(90); delay(750);
  SetBack(20,200,'L');
  motorStop();delay(50);
...
void box3_community()
{ 
  placeCan1_NoShake(37, 3.5, 'l', 'l'); // red base
...
void box4_community()
{
  placeCan1_NoShake(12, 3.5, 'r', 'r'); //Y base
  motorStop();delay(750);
  Balance_Arm('C');
  motorTimeDegree_Enhanced(-30, -60, 100, 'L');
  motorTimeDegree_Enhanced(30, 60, 200);
  SetBack(20, 250, 'L');
  motorStop();delay(50);
