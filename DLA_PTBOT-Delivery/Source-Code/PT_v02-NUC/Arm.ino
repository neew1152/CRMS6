...
////////////////////////////////////////////////////////
int Swing_Left = 57;          //S0 สวิงแขนซ้าย เพิ่มง้างออก ลด หุบเข้า
int Swing_Right = 55;         //S1 สวิงแขนขวา เพิ่มง้างออก ลด หุบเข้า
int Swing_Left_side = 68;     //S0 สวิงแขนซ้าย วางป๋องซ้าย เพิ่มง้างออก ลด หุบเข้า
int Swing_Left_center = 37;   //S0 สวิงแขนซ้าย วางป๋องกลาง เพิ่มง้างออก ลด หุบเข้า
int Swing_Right_side = 68;    //S1 สวิงแขนขวา วางป๋องขวา เพิ่มง้างออก ลด หุบเข้า
int Swing_Right_center = 37;  //S1 สวิงแขนขวา วางป๋องกลาง เพิ่มง้างออก ลด หุบเข้า
////////////////////////////////////////////////////////
int Open_Left = 110;  //S2 อ้ามือ ชุดมือจับมือซ้ายค่ามากยิ่งหุบ
int Open_Right = 90;  //S3 อ้ามือ ชุดมือจับมือขวา ค่ามากยิ่งหุบ
////////////////////////////////////////////////////////
int Close_Left = 110 + 30;  //S2 หุบมือ ชุดมือจับมือซ้ายค่าน้อยยิ่งอ้า
int Close_Right = 90 + 30;  //S3 หุบมือ ชุดมือจับมือขวา ค่าน้อยยิ่งอ้า
////////////////////////////////////////////////////////
...
void TS() {
  ...
  servoWrite(chanal_Swing_Left, 150);
  servoWrite(chanal_Swing_Right, 150);
...
void placeCan1(int drop_height, int distance, char from_gripper, char drop_point) {
  ...
  } else if (from_gripper == 's' && drop_point == 's') {
    servoWrite(chanal_Swing_Left, Swing_Left);
    servoWrite(chanal_Swing_Right, Swing_Right);
  } else {
    vTaskResume(switchGripperTaskHandle);
  ...
  setAngleOffset();
  current_degree = 0;
  BB(10, distance);  // ถอย หลังมาจะสำพันธ์กำวาง ด้าน l r C
  // lift(drop_height);
  delay(200);
  if (switch_can == 0) dropCan(from_gripper);  // ไปคอมเม๊นเขย่ากระป๋อง ที่ //shakeGripper('l');
  else dropCan(drop_point);
  delay(200);
  vTaskSuspend(switchGripperTaskHandle);
}
void placeCan1_1(int drop_height, int distance, char from_gripper, char drop_point, int B_Speed, int B_delay) {
  bool switch_can = 0;
  delay(300);
  lift(1);
  servoCloseLeft();
...
void placeCan1_1_Norechack(int drop_height, int distance, char from_gripper, char drop_point, int B_Speed, int B_delay) {
  ...
  if (from_gripper == 'l' && drop_point == 'l') {
    swingGripper('l', Swing_Left_side);
    swingGripper('r', Swing_Right + 40);
  } else if (from_gripper == 'l' && drop_point == 'c') {
    swingGripper('l', Swing_Left_center);
    swingGripper('r', Swing_Right + 60);
  } else if (from_gripper == 'r' && drop_point == 'r') {
    swingGripper('l', Swing_Left + 40);
    swingGripper('r', Swing_Right_side);
  } else if (from_gripper == 'r' && drop_point == 'c') {
