...
int Swing_Left = 90;   // SO
int Swing_Right = 90;  // S1
...
void pickCan_Test(int pick_height, bool switch_lr, int B_Speed, int B_delay) {
  Balance_Arm('O');
  lift(pick_height);
  delay(200);
