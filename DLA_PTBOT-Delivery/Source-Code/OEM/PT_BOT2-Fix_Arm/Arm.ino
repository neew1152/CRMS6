...
int Close_Left = 97;  //S2 หุบมือ ชุดมือจับมือซ้ายค่าน้อยยิ่งอ้า เขียว
////////////////////////////////////////////////////
...
int Close_Right = 97;  //S3 หุบมือ ชุดมือจับมือขวา ค่าน้อยยิ่งอ้า เขียว
////////////////////////////////////////////////////
...
void pickCan(int pick_height, bool switch_lr) {
  ...
  if (switch_lr == 1) {
    ...
    lift(0);
    delay(700);
    swingGripper('l', Swing_Left - (switch_degree + 14));
    delay(200);
    servoWrite(chanal_Gripper_Left, Open_Left);
    delay(200);
    lift(pick_height + 18); //--Adjust hight (above cans)
    delay(1000);
    switchGripper('r', 'l');
    delay(1000);
    servoWrite(chanal_Gripper_Right, Open_Right - 10);
    swingGripper('r', Swing_Right - (switch_degree + 16));
    lift(0);
    delay(2000);
    servoWrite(chanal_Gripper_Left, (Close_Left - 33));
    // FF(20, 300);
    delay(300);
    servoWrite(chanal_Gripper_Left, Open_Left);
    // FF(20, 100);
