...
//                   S0   S1   S2   S3
int sensor_min[] = { 100, 100, 100, 100 };  // ค่าสีดำ
int sensor_max[] = { 500, 350, 500, 500 };  // ค่าสีขาว
...
float Place_can_distance = 7;  // ค่าระยะจอดหน้าแท่นหยิบ
...
void setup() {
  ...
  // setupColorSensor();
  setupServo();  // * ให้ขันน็อตปรับความแน่นของแขนซ้ายขวาให้ไม่สั่นก่อน
  lift(2);
  beep(100);
  delay(100);
  STOP();
