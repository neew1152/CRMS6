void operation_community()
{
  ...
  // 1 = 200, 1.5 = 275, 3 = 500, Hight Way = 1200 1400
  // ShowValue_Sensor();
...
void box4_community()
{
  placeCan1_NoShake(12, 4, 'r', 's');
  motorStop();delay(750);
  Balance_Arm('C');
  motorTimeDegree_Enhanced(-30, -60, 50, 'R');
  motorTimeDegree_Enhanced(-30, -60, 200);
  SetBack(20, 250, 'L'); // Face to GR
  motorStop();delay(50);
}
...
void box8_community()
{
  ...
  motorStop();delay(50);
  motorTimeDegree_Enhanced(-30, -60, 1400, 'R');
  motorTimeDegree_Enhanced(-30, -60, 200);
  SetBack(20, 250, 'L');
  motorStop();delay(50);
  motorTimeDegree_Enhanced(30, 60, 500); // Face to red base
