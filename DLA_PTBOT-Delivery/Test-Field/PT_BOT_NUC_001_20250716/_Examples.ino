...
void Examples() {
  // moveToCan0(int distance); // Forward until the set distance
  ...
  placeCan1_NoShake(10, 3, 'l', 'c');      // วาง 1 กระป๋อง placeCan(ความสูง หน่วยเป็นเซ็นติเมตร, ระยะจอด, เลือกมือจับ, ตำแหน่งวาง)
  //                       'l' = ใช้มือจับด้ายซ้าย
  //                       'r' = ใช้มือจับด้ายขวา
  //                            'l' = วางตำแหน่งด้านซ้าย
  //                            'c' = วางตำแหน่งตรงกลาง
  //                            'r' = วางตำแหน่งด้านขวา
  //                            's' = วางตำแหน่งแบบตรง 
  placeCan2_NoShake(10, 3, 'c', 'l');      // วาง 2 กระป๋อง placeCan(ความสูง หน่วยเป็นเซ็นติเมตร, ระยะจอด, ตำแหน่งวางของมือซ้าย, ตำแหน่งวางของมือขวา)
  //                       'l' = วางตำแหน่งด้านซ้าย
  //                       'c' = วางตำแหน่งตรงกลาง
  //                       'r' = วางตำแหน่งด้านขวา
  //                       's' = วางตำแหน่งแบบตรง 
