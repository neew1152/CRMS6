Write-Host "Disable all Spectre/Meltdown mitigations to mimic an unpatched system"
...
Write-Host "Weaken Crypto Settings to allow outdated protocols"
Set-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL" -Name "Enabled" -Value 1
Write-Host "[ OK ]"
Write-Host ""

Write-Host "Allow Remote Desktop connections to lure attackers"
Set-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\Terminal Server" -Name "fDenyTSConnections" -Value 0 -Type DWord
Enable-NetFirewallRule -DisplayGroup "Remote Desktop"
Write-Host "[ OK ]"
Write-Host ""

Write-Host "Weaken password policy to attract brute-force attempts"
net accounts /minpwlen:4 /maxpwage:7
Write-Host "[ OK ]"
Write-Host ""

Write-Host "Enable detailed security event logging to capture attacker activity"
...
Write-Host "Enable Guest account to make the system more accessible"
net user Guest /active:yes
Write-Host "[ OK ]"
Write-Host ""

Write-Host "Change DNS"
